...
//
//
//        String filePath = "classpath:static/" + 3 + "/data.csv";
...
//                file = new File(uri.getPath(), Integer.toString(3) + "/data.csv");
//                if (!file.exists()) {
...
//        File file = FileUtil.file("classpath:static/" + 3 + "/data.csv"); // 如果data.csv位于classpath:static目录下
//        // 设置请求参数
